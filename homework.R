...
#List names of students collaborating with (no more than 2): Hanzhi Wang, Jaiyue Sun
...
#MComment: Looks good! Check out ways to pull info from the file name below - 
library(tidyr)
